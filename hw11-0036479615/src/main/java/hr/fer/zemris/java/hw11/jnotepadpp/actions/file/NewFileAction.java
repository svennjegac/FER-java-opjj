...
/**
 * Action which i performed when user wants to open new tab.
 * 
 * @author Sven Njegač
 * @version 1.0
 */
public class NewFileAction extends AbstractJNotepadPPLocalizableAction {
	 ...
	 */
	public NewFileAction(String name, KeyStroke stroke, int event, JNotepadPP jNotepadPP, ILocalizationProvider flp) {
		super(name, stroke, event, jNotepadPP, flp);
	}
	
	@Override
	public void actionPerformed(ActionEvent e) {
		Tab tab = new Tab(jNotepadPP, "", null, true);
