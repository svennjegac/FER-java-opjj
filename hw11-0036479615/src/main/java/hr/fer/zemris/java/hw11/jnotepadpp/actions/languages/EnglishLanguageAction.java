...
/**
 * Action invoked when user wants to use english language.
 * 
 * @author Sven Njegač
 * @version 1.0
 */
public class EnglishLanguageAction extends AbstractJNotepadPPLocalizableAction {
	 ...
	 */
	public EnglishLanguageAction(String name, JNotepadPP jNotepadPP, ILocalizationProvider flp) {
		super(name, jNotepadPP, flp);
	}
	
	@Override
	public void actionPerformed(ActionEvent e) {
		LocalizationProvider.getInstance().setLanguage(LocalizationProvider.ENGLISH);
