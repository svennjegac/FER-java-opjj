...
public class Client2 {
	...
	/** Request. */
	private static String req = "GET /scripts/threading.smscr?p=0 HTTP/1.1\r\n\r\n";
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Resp: '" + response + "', len: " + response.length());
		...
		public void run() {
			try {
				...
				while (true) {
					...
					String req2 = "GET /scripts/threading.smscr?p=" + counter + " HTTP/1.1\r\nCookie: sid=\"" + sid + "\"\r\n\r\n";
