...
public class SmartScriptLexer {
	...
	/**
	 * Method manages whitespace escaping.
	 * If it determines that there was a letter escaped (n, t, r), which
	 * naturally represents a whitespace character, it will be replaced with dedicated
	 * whitespace character.
	 */
	private void manageWhitespaceCharsEscaping() {
