...
public class Prob1Test {
	...
	public void testMultipartInput2() {
		// Test input which has parts which are tokenized by different rules...
		Lexer lexer = new Lexer("Janko.,32aa? \\32\\\\1\\4\\\\$#"
				+ "2 23 Ivana26\\a 463abc 1.\\\\ \\ \\2  \\#zzz ");

		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "Janko"));
		checkToken(lexer.nextToken(), new Token(TokenType.SYMBOL, Character.valueOf('.')));
		checkToken(lexer.nextToken(), new Token(TokenType.SYMBOL, Character.valueOf(',')));
		checkToken(lexer.nextToken(), new Token(TokenType.NUMBER, Long.valueOf(32)));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "aa"));
		checkToken(lexer.nextToken(), new Token(TokenType.SYMBOL, Character.valueOf('?')));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "3"));
		checkToken(lexer.nextToken(), new Token(TokenType.NUMBER, Long.valueOf(2)));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "\\"));
		checkToken(lexer.nextToken(), new Token(TokenType.NUMBER, Long.valueOf(1)));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "4\\"));
		checkToken(lexer.nextToken(), new Token(TokenType.SYMBOL, Character.valueOf('$')));
		...
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "23"));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "Ivana26\\a"));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "463abc"));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "1.\\\\"));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "\\"));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "\\2"));
		checkToken(lexer.nextToken(), new Token(TokenType.WORD, "\\"));
		checkToken(lexer.nextToken(), new Token(TokenType.SYMBOL, Character.valueOf('#')));
